...
<section style="padding-left: 5%;padding-right: 5%;">
    ...
    <h1>User guide :</h1>
    <h4>
To search the database navigate to the search bar on the home page.
First, select the type of search query from the dropdown list on the left of the search bar. The following four options are available:
</h4>
<ul>
    <li>Plant name : Scientific name of an indigenous Indian medicinal plant
    </li>
    <li>Chemical Compound : Name of chemical compound extracted from a medicinal plant 
    </li>
    <li>Target Gene : Gene for which chemical ligands have to be searched
    </li>
    <li>Target Protein : Protein for which chemical ligands have to be searched
    </li>
    
</ul>

<h3>On search the following information will be displayed:
</h3>
<ul>
    <li>Plant name : Scientific name of an indigenous Indian medicinal plant
    </li>
    ...
    <li>Plant information
    </li>
    <li>List of chemical compounds extracted
    </li>
    <li>Target Gene
    </li>
    <li>Target Protein
    </li>
    <li>For Chemical Compound
    </li>
    <li>Chemical information
    </li>
    <li>Target Gene
    </li>
    <li>Target Protein

<script context="module">
	export async function load({ fetch , params }) {
		const res = await fetch('http://backendexpress-env.eba-mstkmt6p.us-east-1.elasticbeanstalk.com/Search/targetprotein/'+params.id);
...
<section style="width:100%;">
	...
	<div style="width: 20%; background-color: aliceblue;top: 1%;">
		<ul style="position: sticky; top: 1%; padding: 7%;list-style-type: disc; color: black;">
			<li style="margin: 5%;"><a class ="linker"href="#pi">Protein Information</a></li>
...
<h1 class="curve gcolor" style="background-color: aquamarine; padding: 1.3%; font-size: larger; color: white;margin-bottom: 2%; font-weight: 600;">
	Compound List 
</h1>
